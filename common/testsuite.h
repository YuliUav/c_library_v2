...
static void mavlink_test_vision_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VISION_DATA >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_vision_data_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,963498712,963498920,101
    };
	mavlink_vision_data_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.vision_x = packet_in.vision_x;
        packet1.vision_y = packet_in.vision_y;
        packet1.vision_z = packet_in.vision_z;
        packet1.vision_vx = packet_in.vision_vx;
        packet1.vision_vy = packet_in.vision_vy;
        packet1.vision_vz = packet_in.vision_vz;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VISION_DATA_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VISION_DATA_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_data_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_vision_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_data_pack(system_id, component_id, &msg , packet1.vision_x , packet1.vision_y , packet1.vision_z , packet1.vision_vx , packet1.vision_vy , packet1.vision_vz , packet1.pixel_x , packet1.pixel_y , packet1.status );
	mavlink_msg_vision_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_data_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.vision_x , packet1.vision_y , packet1.vision_z , packet1.vision_vx , packet1.vision_vy , packet1.vision_vz , packet1.pixel_x , packet1.pixel_y , packet1.status );
	mavlink_msg_vision_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vision_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_data_send(MAVLINK_COMM_1 , packet1.vision_x , packet1.vision_y , packet1.vision_z , packet1.vision_vx , packet1.vision_vy , packet1.vision_vz , packet1.pixel_x , packet1.pixel_y , packet1.status );
	mavlink_msg_vision_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_formation(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FORMATION >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_formation_t packet_in = {
		963497464,963497672,963497880,101.0,129.0,157.0,77
    };
	mavlink_formation_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.lon = packet_in.lon;
        packet1.lat = packet_in.lat;
        packet1.alt = packet_in.alt;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FORMATION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FORMATION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_formation_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_formation_pack(system_id, component_id, &msg , packet1.lon , packet1.lat , packet1.alt , packet1.vel_n , packet1.vel_e , packet1.vel_d , packet1.status );
	mavlink_msg_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_formation_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.lon , packet1.lat , packet1.alt , packet1.vel_n , packet1.vel_e , packet1.vel_d , packet1.status );
	mavlink_msg_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_formation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_formation_send(MAVLINK_COMM_1 , packet1.lon , packet1.lat , packet1.alt , packet1.vel_n , packet1.vel_e , packet1.vel_d , packet1.status );
	mavlink_msg_formation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_formation_to_gcs(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FORMATION_TO_GCS >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_formation_to_gcs_t packet_in = {
		17.0,17,84
    };
	mavlink_formation_to_gcs_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.dock_time = packet_in.dock_time;
        packet1.dock_status = packet_in.dock_status;
        packet1.status = packet_in.status;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FORMATION_TO_GCS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FORMATION_TO_GCS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_formation_to_gcs_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_formation_to_gcs_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_formation_to_gcs_pack(system_id, component_id, &msg , packet1.dock_time , packet1.dock_status , packet1.status );
	mavlink_msg_formation_to_gcs_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_formation_to_gcs_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.dock_time , packet1.dock_status , packet1.status );
	mavlink_msg_formation_to_gcs_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_formation_to_gcs_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_formation_to_gcs_send(MAVLINK_COMM_1 , packet1.dock_time , packet1.dock_status , packet1.status );
	mavlink_msg_formation_to_gcs_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gcs_to_formation(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GCS_TO_FORMATION >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_gcs_to_formation_t packet_in = {
		93372036854775807ULL,963497880,963498088,963498296
    };
	mavlink_gcs_to_formation_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.lon = packet_in.lon;
        packet1.lat = packet_in.lat;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GCS_TO_FORMATION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GCS_TO_FORMATION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gcs_to_formation_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_gcs_to_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gcs_to_formation_pack(system_id, component_id, &msg , packet1.time_usec , packet1.lon , packet1.lat , packet1.alt );
	mavlink_msg_gcs_to_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gcs_to_formation_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.lon , packet1.lat , packet1.alt );
	mavlink_msg_gcs_to_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_gcs_to_formation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gcs_to_formation_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.lon , packet1.lat , packet1.alt );
	mavlink_msg_gcs_to_formation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_vision_data(system_id, component_id, last_msg);
	mavlink_test_formation(system_id, component_id, last_msg);
	mavlink_test_formation_to_gcs(system_id, component_id, last_msg);
	mavlink_test_gcs_to_formation(system_id, component_id, last_msg);
}
