...
#define MAVLINK_MSG_ID_FORMATION 151
...
#define MAVLINK_MSG_ID_FORMATION_LEN 25
#define MAVLINK_MSG_ID_FORMATION_MIN_LEN 25
#define MAVLINK_MSG_ID_151_LEN 25
#define MAVLINK_MSG_ID_151_MIN_LEN 25

#define MAVLINK_MSG_ID_FORMATION_CRC 125
#define MAVLINK_MSG_ID_151_CRC 125
...
static inline uint16_t mavlink_msg_formation_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       int32_t lon, int32_t lat, int32_t alt, float vel_n, float vel_e, float vel_d, int8_t status)
{
...
{
	return mavlink_msg_formation_pack(system_id, component_id, msg, formation->lon, formation->lat, formation->alt, formation->vel_n, formation->vel_e, formation->vel_d, formation->status);
}
...
{
	return mavlink_msg_formation_pack_chan(system_id, component_id, chan, msg, formation->lon, formation->lat, formation->alt, formation->vel_n, formation->vel_e, formation->vel_d, formation->status);
}
...
static inline void mavlink_msg_formation_send(mavlink_channel_t chan, int32_t lon, int32_t lat, int32_t alt, float vel_n, float vel_e, float vel_d, int8_t status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_FORMATION_LEN];
	_mav_put_int32_t(buf, 0, lon);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_formation_send(chan, formation->lon, formation->lat, formation->alt, formation->vel_n, formation->vel_e, formation->vel_d, formation->status);
#else
 ...
 */
static inline void mavlink_msg_formation_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int32_t lon, int32_t lat, int32_t alt, float vel_n, float vel_e, float vel_d, int8_t status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
